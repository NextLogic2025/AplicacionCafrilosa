...
export function SellerOrderScreen() {
    ...
    const [condition, setCondition] = useState('contado') // contado, credito

    // Update client if params change (e.g. navigation from Client Detail)
    useEffect(() => {
    ...
    const handleAddItem = () => {
        // Mock add item logic - In real app, open Product Selector Modal
        ...
        Alert.alert('Pedido Enviado', 'El pedido ha sido enviado a bodega.', [
            {
                text: 'OK', onPress: () => {
                    ...
                    // Optional: clear client or navigate away
                }
            }
        ])
    }
