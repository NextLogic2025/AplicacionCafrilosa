 ...
 *
 * Backend:
 * - Endpoint: GET /api/orders?vendedor_id={id}
 * - Cuando el backend implemente filtros, automáticamente funcionará
 */
export function SellerOrderHistoryScreen() {
    ...
    // Cargar pedidos cuando se enfoca la pantalla
    useFocusEffect(
        useCallback(() => {
            if (userId) {
                loadOrders()
    ...
    // Filtrar pedidos localmente (mientras el backend implementa filtros)
    useEffect(() => {
        let filtered = [...orders]

        // Filtrar por búsqueda (código visual)
        if (searchQuery.trim()) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.filtersSection}>
                ...
                {/* Estado filter dropdown - simplified */}
