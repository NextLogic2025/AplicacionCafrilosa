...
const styles = StyleSheet.create({
    ...
    statusCard: { flexDirection: 'row', alignItems: 'center', padding: 20, borderRadius: 12, gap: 16 },
    ...
    infoCard: { backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, gap: 12, borderWidth: 1, borderColor: '#E5E7EB' },
    infoRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
    infoText: { fontSize: 14, color: '#1F2937', fontWeight: '600', flex: 1 },
    ...
    productItem: { backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#E5E7EB' },
    productHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 4 },
    productName: { fontSize: 15, fontWeight: '700', color: '#1F2937', flex: 1 },
    bonificacionBadge: { backgroundColor: '#10B981', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
    bonificacionText: { fontSize: 10, fontWeight: '700', color: '#FFFFFF' },
    productSKU: { fontSize: 12, color: '#6B7280', marginBottom: 8 },
    productDetails: { gap: 6 },
    productDetailRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    productDetailLabel: { fontSize: 13, color: '#6B7280' },
    productDetailValue: { fontSize: 13, color: '#1F2937', fontWeight: '600' },
    productTotal: { fontSize: 14, color: '#DC2626', fontWeight: '700' },
    emptyProducts: { backgroundColor: '#FFFFFF', borderRadius: 12, padding: 40, alignItems: 'center', gap: 8, borderWidth: 1, borderColor: '#E5E7EB' },
    emptyProductsText: { fontSize: 14, color: '#6B7280', textAlign: 'center' },
    totalsCard: { backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#E5E7EB' },
    ...
    totalValue: { fontSize: 14, color: '#1F2937', fontWeight: '600' },
    divider: { height: 1, backgroundColor: '#E5E7EB', marginVertical: 8 },
    totalFinalLabel: { fontSize: 16, color: '#1F2937', fontWeight: '700' },
    totalFinalValue: { fontSize: 20, color: '#DC2626', fontWeight: '700' },
    actionSection: { padding: 20, paddingBottom: 40 },
    actionButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#DC2626', paddingVertical: 14, paddingHorizontal: 20, borderRadius: 12, gap: 8 },
