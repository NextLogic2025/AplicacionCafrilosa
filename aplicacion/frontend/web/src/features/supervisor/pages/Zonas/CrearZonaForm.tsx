  ...
  return (
    <form className="space-y-4" onSubmit={onSubmit}>
      ...
      <div className="grid gap-2">
        <label className="text-xs text-neutral-600">Macrorregión (opcional)</label>
        <select
          value={formData.macrorregion ?? ''}
          onChange={(e) => setFormData((prev) => ({ ...prev, macrorregion: e.target.value || undefined }))}
        ...
        >
          <option value="">Sin macrorregión</option>
