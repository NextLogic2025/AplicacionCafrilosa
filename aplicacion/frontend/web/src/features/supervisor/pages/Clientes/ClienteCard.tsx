...
export function ClienteCard({ cliente, onEdit, onDelete, onView, zonas, listasPrecios }: ClienteCardProps) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      {/* Encabezado */}
