...
export function SplashPage() {
  ...
  React.useEffect(() => {
    // Mostrar splash por 2 segundos y redirigir según sesión local.
  ...
  return (
    <div className="relative grid min-h-dvh place-items-center overflow-hidden bg-brand-red" aria-label="Cargando Cafrilosa">
