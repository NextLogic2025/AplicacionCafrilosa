...
export const PrimaryButton = React.memo(function PrimaryButton({ title, onPress, loading, disabled, style }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {loading ? <ActivityIndicator color="#fff" /> : <Text className="font-extrabold text-white">{title}</Text>}
      </LinearGradient>
    </Pressable>
  )
})
